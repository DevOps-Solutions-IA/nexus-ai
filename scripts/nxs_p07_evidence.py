"""Generate NXS-P07 evidence files from real command outputs (never fabricated).
...
EVIDENCE = ROOT / ".nxs" / "evidence" / "NXS-P07"
PHASE = "NXS-P07"
BRANCH = "feat/nxs-p07-integration-hub"
...
def main() -> int:
    ...
    pytest_evidence(
        "unit-primitives",
        [
            "tests/unit/test_integration_destination.py",
            "tests/unit/test_integration_primitives.py",
            "tests/unit/test_integration_executor.py",
            "tests/unit/test_integration_auth_openapi_webhook.py",
        ],
    )
    pytest_evidence(
        "ssrf-and-secret-security",
    ...
    pytest_evidence(
        "concurrency",
        ["tests/concurrency/test_integration_concurrency.py"],
    )
    pytest_evidence(
        "resilience",
        ["tests/resilience/test_integration_resilience.py"],
    )
    pytest_evidence(
        "contracts",
