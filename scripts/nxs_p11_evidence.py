"""Generate NXS-P11 evidence files from real command outputs (never fabricated).
...
def main() -> int:
    ...
    pytest_evidence(
        "security",
        ["tests/security/test_telephony_security.py"],
    )
    pytest_evidence(
    ...
    pytest_evidence(
        "concurrency",
        ["tests/concurrency/test_telephony_concurrency.py"],
    )
    pytest_evidence(
        "resilience",
        ["tests/resilience/test_telephony_resilience.py"],
    )
    pytest_evidence(
        "contracts",
        ["tests/contracts/test_telephony_contracts.py"],
    )
