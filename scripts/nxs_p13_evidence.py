"""Generate NXS-P13 evidence files from real command outputs (never fabricated).
...
EVIDENCE = ROOT / ".nxs" / "evidence" / "NXS-P13"
PHASE = "NXS-P13"
BRANCH = "feat/nxs-p13-agent-runtime"
...
def main() -> int:
    ...
    pytest_evidence(
        ...
        [
            ...
            "tests/concurrency/test_agent_model_dispatch_fencing.py",
        ],
    )
    pytest_evidence(
        "resilience",
        ["tests/resilience/test_agent_resilience.py"],
    )
    pytest_evidence(
        "contracts",
