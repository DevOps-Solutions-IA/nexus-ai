"""Generate NXS-P10 evidence files from real command outputs (never fabricated).
...
EVIDENCE = ROOT / ".nxs" / "evidence" / "NXS-P10"
PHASE = "NXS-P10"
BRANCH = "feat/nxs-p10-otp"
...
def main() -> int:
    ...
    pytest_evidence(
        "unit-primitives",
        ["tests/unit/test_otp_primitives.py"],
    )
    pytest_evidence(
        "security",
        ["tests/security/test_otp_security.py"],
    )
    pytest_evidence(
        "otp-integration",
        [
            "tests/integration/test_otp_service.py",
            "tests/integration/test_otp_api.py",
        ],
    )
    pytest_evidence(
        "concurrency",
        ["tests/concurrency/test_otp_concurrency.py"],
    )
    pytest_evidence(
        "resilience",
        ["tests/resilience/test_otp_resilience.py"],
    )
    pytest_evidence(
        "contracts",
        ["tests/contracts/test_otp_contracts.py"],
    )
